    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-10 col-lg-9 col-md-12 d-flex flex-row justify-content-center">
                ...
                <h1>Data Kamar</h1>
                <table class="table table-striped table-hover table-sm overflow-x-scroll mt-5">
                    <tr>
                        <th>No</th>
                        <th>ID Kamar</th>
                        <th>Nomor Kamar</th>
...
include 'koneksi.php';
$no = 1;
$hasil = $conn->query("SELECT * FROM rooms WHERE status='ready' OR status='booked'");
?>
                    <?php
while ($row = $hasil->fetch_assoc()) {
    ?>
                        <tr>
                            ...
                            <td><?=$row['visitor'];?></td>
                            <td>
                                <a href="dashboard-staff-form-reservation.php?edit=<?=$row['id'];?>" class="btn btn-success btn-sm">Booking</a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="hapusModalLabel">Konfirmasi Checkout</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <p>Apakah Anda yakin ingin meng checkout ruangan ini?</p>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                        <a href="checkout.php?id=<?=$row['id'];?>" class="btn btn-danger">Checkout</a>
                                    </div>
                                </div>
                            </div>
                        </div>
